...
func TestFunctionObject(t *testing.T) {
	...
	if len(fn.Body.Statements) != 1 {
		t.Fatalf("function has wrong statements. Statements=%+v", fn.Body.Statements)
	}
	expectedBody := "(x + 2)"
...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if !ok {
		t.Errorf("obj is not of type object.Boolean. got=%T (%+v)", obj, obj)
		return false
	}

	if boolObj.Value != expected {
		t.Errorf("boolObj.Value is incorrect. want=%t, got=%t", expected, boolObj.Value)
		return false
	}
...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	objInt, ok := obj.(*object.Integer)
	if !ok {
		t.Errorf("obj is not of type object.Integer. got=%T (%+v)", obj, obj)
		return false
	}

	if objInt.Value != expected {
		t.Errorf("objInt has wrong value. want=%d got=%d", expected, objInt.Value)
		return false
	}
